...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            <p>Hi <strong>{{ $loginDetails['name'] }}</strong>,</p>

            <p>We’re excited to welcome you to the <strong>Azany</strong> admin team! Below are your login details for
                accessing the Admin Portal:</p>
            ...
            <p>For security reasons, we strongly recommend that you log in and change your password as soon as possible.
            </p>
            ...
            <p>If you encounter any issues or have questions, feel free to reach out to us at <a
                    href="mailto:support@shopazany-v2.com">support@shopazany-v2.com</a>.</p>
        ...
        <div class="email-footer">
            <p>&copy; {{ date('Y') }} Azany. All rights reserved.</p>
