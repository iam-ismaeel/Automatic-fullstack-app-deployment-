...
const AddPayment = () => {
  ...
  const { mutateAsync: addPaymentMethod, isPending: isAddingPayment } =
  ...
  const onSubmit = async (data: PaymentFormFields) => {
    ...
    await addPaymentMethod(bankData)
      .then(() => showsuccess("Payment Method Added Successfully"))
            ...
            <div>
              ...
              >
                ...
                {availableMethods.includes("authorize") && (
                  <option value="authorize">Bank Tranfer</option>
                )}
