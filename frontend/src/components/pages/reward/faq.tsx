...
const Faq = () => {
  return (
    <div className="bg-[#F8F8F8] py-[70px] px-[130px] 2xl:px-[70px] xl:px-[40px] lg:px-0 smd:px-4 ">
      <section className="max-w-7xl bg-[#fcf6f6] mx-auto flex flex-col items-center justify-center gap-y-[56px]">
